    ...
    <div className="min-h-screen bg-transparent flex flex-col justify-between font-body text-white">
      <div className="mx-auto w-full max-w-4xl px-6 py-12">
        ...
        <div className="ticket-card mt-8 p-6 sm:p-10">
          <div className="ticket-stamp inline-block rounded px-2.5 py-1 font-mono text-[10px] uppercase tracking-widest text-gold">`n            PREPPASS GUIDE
          </div>
          <h1 className="mt-4 font-heading text-3xl text-gold sm:text-4xl">
            How PrepPass Works
          </h1>
          <p className="mt-2 text-sm text-white leading-relaxed max-w-2xl">
        ...
        <div className="ticket-card mt-12 p-8 text-center bg-[#130E2E]/80 border border-white/10">
          ...
          <p className="mt-2 text-xs text-white max-w-md mx-auto">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
            <Link
              ...
              className="inline-flex items-center justify-center rounded-lg bg-gold px-6 py-3 font-heading font-semibold text-[#0B0A14] hover:bg-gold-dark"
            >
