        ...
        {leaves.map((leaf) => (
          <g
            ...
            style={{
              ...
              animation: \\\sway \\\s ease-in-out infinite alternate \\\s\\\,
            }}
          >
            {/* Outer Glow */}
            <circle
            ...
            <circle
              ...
              fill={leaf.coreColor}
              style={{
                animation: \\\pulseGlow \\\s ease-in-out infinite alternate \\\s\\\,
...
;
fs.writeFileSync('client/src/components/landing/HeroIllustration.jsx', content.replace(/\\\\\\\/g, '\'), 'utf8');
